...
{{--                                    <p>số lượng: <span>{{ $product->stock }}</span></p>--}}
                                ...
                                <div class="single-product-color" style=" margin-top: 15px;">
                                    <div class="fb-like" data-href="https://viettelstore.com/" data-width="" data-layout="button" data-action="like" data-size="large" data-share="true"></div>
                                </div>
                ...
                <div class="container-fluid">
                    <div class="fb-comments" data-href="https://viettelstore.com/" data-numposts="5" data-width=""></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <script type="text/javascript">
        ...
        function addToCart() {
            ...
            $.ajax({
                ...
                success: function () { // success : kết quả trả về sau khi gửi request ajax
                    alert("Thêm sản phẩm thành công");
                    window.location='https://viettelstore.com/dat-hang';

                },
                error: function () { // lỗi nếu có
                    alert("Sản phẩm hiện tại không đủ hàng, mời bạn chọn sản phẩm khác!");
                    window.location='https://viettelstore.com/';
                }
            });
